  ...
  this.Drb_preparation = (clasz = Object) => {
    return class extends clasz {
      ...
      _add_special_glyfs(fontnick, font_idx, fm) {
        ...
        var bottom, chrs, gd, gd_blob, gid, i, insert_outline, left, len, marker, olt, owdth, ref, right, row/* Glyf Data Blob */, special_key, specials, swdth, text_x, text_y, top, x1, x2, y1, y2;
