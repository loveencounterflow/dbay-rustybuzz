  ...
  this.Drb_preparation = (clasz = Object) => {
    return class extends clasz {
      ...
      _add_special_glyfs(fontnick, font_idx, fm) {
        ...
        var bottom, chrs, cr, cswdth, cx, cy, gd, gd_blob, gid, i, insert_outline, j, left, len, len1, marker, olt, owdth, ref, ref1, rheight, right, row/* Glyf Data Blob */, rwidth, special, special_key, specials, swdth, text_x, text_y, top, width, x1, x2, y1, y2;
...
<rect x='${left}' y='${top}' width='${rwidth}' height='${rheight}'/>
          ...
          gd_blob = this._zip(gd);
          /* TAINT must rename fields x, y, y1, y1 in tables ads, outlines */
          /* Glyf Data Blob */          row = this.db.first_row(insert_outline, {
            fontnick,
            gid,
            chrs,
            x: 0,
