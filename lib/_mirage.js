(function() {
  ...
  types.declare('mrg_walk_line_rows_cfg', {
    tests: {
      ...
      "@isa.boolean x.keep_locs": function(x) {
        return this.isa.boolean(x.keep_locs);
      }
    }
  });
  ...
  returning *;`,
      ...
      _refresh_datasource(cfg) {
        ...
        if (force || (digest !== current_digest)) {
          //.....................................................................................................
          this.db(() => {
            var del, i, insert_line, insert_lnpart, insert_locid, isloc, kernel, len, line, lnpart, lnr, locid, part, parts, props, ref;
