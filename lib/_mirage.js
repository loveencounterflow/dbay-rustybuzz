  ...
  this.Mrg = (function() {
    class Mrg {
      ...
      _procure_infrastructure() {
        ...
        var prefix;
        ({prefix} = this.cfg);
        this.db(SQL`drop view   if exists ${prefix}_lines;
...
create view ${prefix}_prv_nxt_xtra_from_dsk_locid as
  ...
  limit 1;`);
        //.......................................................................................................
        this.db(SQL`-- needs variables 'dsk', 'keep_locs'
...
insert into ${prefix}_mirror ( dsk, lnr, lnpart, xtra, line )
  ...
  returning *;`,
      ...
      walk_line_rows(cfg) {
        ...
        this.db.setv('keep_locs', keep_locs != null ? (keep_locs ? 1 : 0) : null);
