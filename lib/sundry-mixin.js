  ...
  this.Drb_sundry = (clasz = Object) => {
    return class extends clasz {
      ...
      _decode_entities(text) {
        ...
        R = R.replace(/&wbr;/g, this.constructor.C.specials.wbr.chrs);
        R = R.replace(/&nl;/g, this.constructor.C.specials.nl.chrs);
        return R;
      }
      ...
      _uax14(text) {
        ...
        var R, bri, bris, idx, parts, specials, text_bfr;
...
//.......................................................................................................
  ...
  order by b1;`);
      ...
      _get_sid({fontnick, gid}) {
        return `o${gid}${fontnick}`;
      }
