(function() {
  ...
  this.declare('dbr_shape_text_cfg', {
    tests: {
      ...
      "@isa.integer x.vrt": function(x) {
        return this.isa.integer(x.vrt);
      }
    }
  });
  ...
  this.declare('dbr_prepare_text_cfg', {
    tests: {
      ...
      "@isa.boolean x.ncrs": function(x) {
        return this.isa.boolean(x.ncrs);
      },
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.declare('dbr_decode_entities_cfg', {
    tests: {
      "@isa.object x": function(x) {
        return this.isa.object(x);
      },
