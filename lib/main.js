(function() {
  'use strict';
  var CND, Drb_codepoints, Drb_distribution, Drb_outlines, Drb_preparation, PATH, SQL, ZLIB, badge, debug, echo, font_path, guy, help, home, info, isa, rpr, type_of, types, urge, validate, validate_list_of, warn, whisper;
