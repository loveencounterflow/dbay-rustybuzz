(function() {
  'use strict';
  var CND, Drb_outlines, PATH, RBW, SQL, badge, debug, echo, font_path, guy, help, home, info, isa, rpr, type_of, types, urge, validate, validate_list_of, warn, whisper;
  ...
  this.Drb = (function() {
    class Drb extends Drb_outlines() {
      ...
      _create_db_structure() {
        var decompress_clause, outline_type, prefix, schema;
        ({prefix, schema} = this.cfg);
        if (this.cfg.compress_svg) {
          outline_type = 'blob';
    ...
    primary key ( fontnick, gid ) );`);
      ...
      _compile_sql() {
        ...
        guy.props.hide(this, 'sql', {
          ...
          insert_outline: this.db.create_insert({
            schema,
            into: 'outlines',
            fields: ['fontnick', 'gid', 'cid', 'glyph', 'x', 'y', 'x1', 'y1', 'pd'],
            on_conflict: {
              update: true
            }
          }),
      ...
      _create_sql_functions() {
        ...
        this.db.create_function({
          ...
          varargs: false,
          call: (pd_bfr) => {
            return this._decompress_svg_pathdata(pd_bfr);
          }
        });
        //.......................................................................................................
        return null;
