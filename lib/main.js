(function() {
  'use strict';
  var CND, Drb_arrangement, Drb_codepoints, Drb_distribution, Drb_outlines, Drb_preparation, Drb_sundry, E, PATH, SQL, ZLIB, badge, debug, echo, font_path, guy, help, home, info, isa, rpr, special_chrs, type_of, types, urge, validate, validate_list_of, warn, whisper;
      ...
      _compile_sql() {
        ...
        guy.props.hide(this, 'sql', {
          ...
          insert_ad: this.db.create_insert({
            schema,
            into: 'ads',
            fields: ['doc', 'par', 'trk', 'b1', 'b2', 'sgi', 'osgi', 'gid', 'x', 'y', 'dx', 'dy', 'chrs', 'sid', 'nobr', 'br'],
            returning: '*'
          }),
          //.....................................................................................................
