...
from ${schema}.ads where ( doc = $doc ) and ( par = $par );`, {doc, par}));
  ...
  order by b1, id;`, {doc, par, shy_b1, shy_sgi}));
      ...
      //---------------------------------------------------------------------------------------------------------
      _shape_text(cfg) {
        var ad, ads, b1/* NOTE optional leftmost byte index */, b2/* NOTE optional rightmost byte index */, ced_x, ced_y, delta_x, doc, dx0/* NOTE optional leftmost  x reference coordinate */, dx2/* NOTE optional rightmost x reference coordinate */, ed_x, font_idx, fontmetrics, fontnick, i, idx, len, missing, osgi, par, schema, sgi, skip_ends, specials, text, trk, width;
...
/* TAINT will probably be removed */        if (b1 == null) {
        ...
        ({specials, fontmetrics} = this.constructor.C);
        ({missing} = specials);
        ({schema} = this.cfg);
        //.......................................................................................................
