  ...
  this.Drb_arrangement = (clasz = Object) => {
    return class extends clasz {
      ...
      _shape_hyphenated(cfg) {
        ...
        var I, L, V, ads, b1, b2, doc, dx0, dx2, fontnick, i, left_ads, len, new_trk, par, ref, right_ads, schema, shy, shy_b1, shy_sgi, text, trk_max;
...
from ${schema}.ads where ( doc = $doc ) and ( par = $par );`, {doc, par}));
  ...
  order by b1, id;`, {doc, par, shy_b1, shy_sgi}));
      ...
      _prepare_ads(text, fontnick, ads) {
        ...
        var R, ad, byte_counts, bytes, extra_ad, has_shy, has_wbr, i, idx, ignored, len, nl, prv_ad, ref, ref1, special_chrs;
        R = [];
        ({special_chrs, byte_counts, nl, ignored} = this.constructor.C);
      ...
      //---------------------------------------------------------------------------------------------------------
      _shape_text(cfg) {
        var ad, ads, b1/* NOTE optional leftmost byte index */, b2/* NOTE optional rightmost byte index */, ced_x, ced_y, delta_x, doc, dx0/* NOTE optional leftmost  x reference coordinate */, dx2/* NOTE optional rightmost x reference coordinate */, ed_x, font_idx, fontnick, i, idx, len, missing, osgi, par, schema, sgi, skip_ends, text, trk, width;
