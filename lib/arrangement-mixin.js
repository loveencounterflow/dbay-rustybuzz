...
from ${schema}.ads where ( doc = $doc ) and ( par = $par );`, {doc, par}));
  ...
  order by adi;`, {doc, par, shy_adi, shy_sgi}));
      ...
      //---------------------------------------------------------------------------------------------------------
      _shape_text(cfg) {
        var ad, ads, alt, ced_x, ced_y, current_adi, delta_x, doc, dx0/* NOTE optional leftmost  x reference coordinate */, dx2/* NOTE optional rightmost x reference coordinate */, ed_x, font_idx, fontnick, i, idx, last_ad, len, missing, osgi, par, schema, sgi, skip_ends, text, width;
