  ...
  this.Drb_arrangement = (clasz = Object) => {
    return class extends clasz {
      ...
      _shape_hyphenated(cfg) {
        ...
        var I, L, V, ads, alt_max, b0, b2, doc, dx0, dx2, fontnick, i, left_ads, len, new_alt, par, ref, right_ads, schema, shy, shy_adi, shy_sgi, text;
...
from ${schema}.ads where ( doc = $doc ) and ( par = $par );`, {doc, par}));
  ...
  where true
    ...
    and ( alt = 1 );`, {doc, par});
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          ({text, b0, b2, dx0} = this.db.first_row(SQL`select
    coalesce(
  ...
  order by adi;`, {doc, par, shy_adi, shy_sgi}));
          ...
          //.....................................................................................................
          ({text, b0, b2, dx2} = this.db.first_row(SQL`select
    coalesce(
      group_concat( case when br = 'shy' then '' else chrs end, '' ),
      '' )                    as text,
    max( x1 )                 as dx2,
  ...
  order by adi;`, {doc, par, shy_adi, shy_sgi}));
      ...
      _prepare_ads(text, fontnick, ads) {
        ...
        var R, ad, adi, byte_counts, bytes, extra_ad, has_shy, has_wbr, i, ignored, len, prv_ad, ref, ref1, special_chrs;
        R = [];
        ...
        for (adi = i = 0, len = ads.length; i < len; adi = ++i) {
          ad = ads[adi];
          ad.b1 = ad.b;
          ad.b2 = (ref = (ref1 = ads[adi + 1]) != null ? ref1.b : void 0) != null ? ref : bytes.length;
          delete ad.b;
      ...
      //---------------------------------------------------------------------------------------------------------
      _shape_text(cfg) {
        var ad, ads, alt, b0/* NOTE optional leftmost byte index */, b2/* NOTE optional rightmost byte index */, ced_x, ced_y, current_adi, delta_x, doc, dx0/* NOTE optional leftmost  x reference coordinate */, dx2/* NOTE optional rightmost x reference coordinate */, ed_x, font_idx, fontnick, i, idx, len, missing, osgi, par, schema, sgi, skip_ends, text, width;
        ({fontnick, text, dx0, dx2, b0, b2, doc, par, alt, osgi} = cfg);
        ({missing} = this.constructor.C);
        skip_ends = (dx0 != null) || (dx2 != null);
/* TAINT will probably be removed */        if (b0 == null) {
          b0 = 0;
        }
        if (b2 == null) {
          b2 = null;
