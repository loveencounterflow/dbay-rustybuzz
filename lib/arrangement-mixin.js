  ...
  this.Drb_arrangement = (clasz = Object) => {
    return class extends clasz {
      ...
      _shape_hyphenated(cfg) {
        ...
        var I, L, V, ads, alt_max, doc, dx0, fontnick, i, left_ads, len, new_alt, par, ref, right_ads, schema, shy, shy_adi, shy_sgi, text;
...
from ${schema}.ads where ( doc = $doc ) and ( par = $par );`, {doc, par}));
  ...
  order by adi;`, {doc, par, shy_adi, shy_sgi}));
      ...
      //---------------------------------------------------------------------------------------------------------
      _shape_text(cfg) {
        var ad, adi, adi_0/* NOTE optional first AD index */, adi_0_given, ads, alt, ced_x, ced_y, doc, dx0/* NOTE optional x reference coordinate */, ed_x, font_idx, fontnick, i, idx, last_ad, last_adi, len, missing, osgi, par, sgi, text, this_adi, width;
        ({fontnick, text, adi_0, dx0, doc, par, alt, osgi} = cfg);
