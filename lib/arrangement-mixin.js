...
from ${schema}.ads where ( doc = $doc ) and ( par = $par );`, {doc, par}));
  ...
  order by b1, id;`, {doc, par, shy_b1, shy_sgi}));
      ...
      _prepare_ads(text, fontnick, ads) {
        ...
        var R, ad, br, byte_counts, bytes, extra_ad, has_shy, has_wbr, i, idx, ignored, len, prv_ad, ref, ref1, special_chrs;
        R = [];
        ({special_chrs, byte_counts, br, ignored} = this.constructor.C);
