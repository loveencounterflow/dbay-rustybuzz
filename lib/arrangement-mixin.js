  ...
  this.Drb_arrangement = (clasz = Object) => {
    return class extends clasz {
      ...
      _shape_hyphenated(cfg) {
        ...
        var I, L, V, ads, alt_max, b1, b2, doc, dx0, dx2, fontnick, i, left_ads, len, new_alt, par, ref, right_ads, schema, shy, shy_adi, shy_sgi, text;
