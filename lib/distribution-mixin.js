(function() {
  ...
  limit $limit;`, {schema, dx0, size_u, width_u, limit});
      ...
      _distribute_with_db(cfg) {
        ...
        ({schema, prefix} = this.cfg);
        //.......................................................................................................
        ({mm_p_u, width_mm, size_mm} = cfg); // nominal type size (1em)
  ...
  order by doc, par, adi;`, {
            ...
            urge('^5850-4^', "line_ads", {lnr});
            console.table(line_ads);
            this.db(() => {
              var ad, i, len, x, y;
              debug('^5850-5^', this.db.all_rows(this.sql.insert_line, {
                doc,
                par,
                lnr,
                x0: brp_1.x,
  ...
  order by doc, par, adi;`, {
            ...
            urge('^5850-8^', "original_shapegroup");
...
select * from ${schema}.ads
  ...
  order by doc, par, adi;`, {
            ...
            this.db(() => {
              var ad, i, len, x, y;
              debug('^5850-10^', this.db.all_rows(this.sql.insert_line, {
                doc,
                par,
                lnr,
                x0: brp_1.x,
            ...
            // debug '^5850-11^ line_ads'; console.table @db.all_rows SQL"select * from #{schema}.line_ads order by 1, 2, 3;"
            /* TAINT does not correctly handle case when shapegroup has elements on right hand side of HHY */
            debug('^5850-12^', original_shapegroup[original_shapegroup.length - 1]);
            debug('^5850-13^', last_osg_adi = original_shapegroup[original_shapegroup.length - 1].adi);
            urge('^5850-14^', "brp_2");
            console.table([brp_2]);
            urge('^5850-15^', "next brp_2");
...
select * from ${schema}.ads
  where true
    ...
    and ( alt = 1 );`, {
            ...
            if (brp_2 == null) {
              warn('^5850-16^', "did not find `end` element");
              break;
            }
        ...
        //.......................................................................................................
        // urge '^5850-18^', "line_ads", { lnr, }; console.table @db.all_rows SQL"select * from #{schema}.line_ads order by 1, 2, 3, 4;"
        return R;
      }
