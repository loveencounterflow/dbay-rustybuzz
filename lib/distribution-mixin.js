...
create view ${schema}.brps as
  ...
  where br is not null;`);
        ...
        console.table(this.db.all_rows(SQL`select * from ${schema}.ads order by adi;`));
        console.table(this.db.all_rows(SQL`select * from ${schema}.brps order by adi;`));
        console.table(this.db.all_rows(SQL`select * from ${schema}.brps order by abs( deviation ) limit 5;`));
        //.......................................................................................................
        v.dx0 = 0;
        nxt_brp = this.db.single_row(SQL`select * from ${schema}.brps where br = 'start' limit 1;`);
        prv_brp = null;
        while (true) {
          if (nxt_brp.br === 'end') {
            break;
          ...
          prv_brp = nxt_brp;
          nxt_brp = this.db.single_row(SQL`select * from ${schema}.brps order by abs( deviation ) limit 1;`);
          adi_1 = prv_brp.adi + 1;
          adi_2 = nxt_brp.adi;
