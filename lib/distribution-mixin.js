(function() {
  ...
  limit $limit;`, {schema, dx0, size_u, width_u, limit});
      ...
      _distribute_with_db(cfg) {
        var R, adi0, ads, brp_1, brp_2, count, doc, dx0, last_osg_adi, line_ads_alt_1, line_ads_brp_2, lnr, mm_p_u, original_shapegroup, par, prefix, schema, size_mm, size_u, width_mm, width_u;
  ...
  order by doc, par, adi;`, {
            ...
            urge('^5850-5^', "original_shapegroup");
  ...
  order by doc, par, adi;`, {
            ...
            debug('^5850-8^', this.db.all_rows(this.sql.insert_line, {
              doc,
              par,
              lnr,
              x0: brp_1.x,
            ...
            brp_2 = this.db.single_row(SQL`select * from ${schema}.ads
  where true
    and ( doc = $doc )
    and ( par = $par )
