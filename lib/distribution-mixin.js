  ...
  this.Drb_distribution = (clasz = Object) => {
    return class extends clasz {
      ...
      _distribute_with_db(cfg) {
        var ads, create_udfs, insert_into_ads, prefix, schema, v;
        ({ads} = cfg);
...
create view ${schema}.brps as
  ...
  where br is not null;`);
        ...
        console.table(this.db.all_rows(SQL`select * from ${schema}.brps order by quality limit 5;`));
        v.dx0 = 9842;
        console.table(this.db.all_rows(SQL`select * from ${schema}.brps order by quality limit 5;`));
        //.......................................................................................................
