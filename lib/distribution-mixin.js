(function() {
  ...
  limit $limit;`, {schema, dx0, size_u, width_u, limit});
      ...
      _distribute_with_db(cfg) {
        var R, adi0, brp_1, brp_2, count, doc, dx0, line_ads, lnr, mm_p_u, original_shapegroup, par, prefix, schema, size_mm, size_u, width_mm, width_u;
        ({schema, prefix} = this.cfg);
        //.......................................................................................................
  ...
  order by doc, par, b1;`, {
            ...
            urge('^5850-11^', "original_shapegroup");
...
select * from ${schema}.ads
  ...
  order by doc, par, x, b1;`, {
            ...
            this.db(() => {
              var ad, i, len, x, y;
              debug('^5850-13^', this.db.all_rows(this.sql.insert_line, {
                doc,
                par,
                lnr,
                x0: brp_1.x,
