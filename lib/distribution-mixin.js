  ...
  this.Drb_distribution = (clasz = Object) => {
    return class extends clasz {
      ...
      /* TAINT use API (?) */      _distribute_with_db(cfg) {
        var R, ads, brp_1, brp_2, count, doc, lines, par, prefix, schema;
        ({ads} = cfg);
        ({schema, prefix} = this.cfg);
        //.......................................................................................................
        ...
        //.......................................................................................................
        urge('^4875^', 'ads');
        console.table(this.db.all_rows(SQL`select doc, par, adi, sgi, vrt, gid, b, x, y, dx, dy, x1, chrs, sid, nobr, br, lnr from ${schema}.ads order by vnr_blob;`));
        urge('^4875^', 'current_brps');
        console.table(this.db.all_rows(SQL`select doc, par, adi, sgi, vrt, gid, b, x, y, dx, dy, x1, chrs, sid, nobr, br, lnr, deviation from ${schema}.current_brps;`));
