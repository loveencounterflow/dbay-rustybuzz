  ...
  this.Drb_distribution = (clasz = Object) => {
    return class extends clasz {
      ...
      _distribute_with_db(cfg) {
        var R, _, adi_1, adi_2, ads, brp_1, brp_2, count, insert_into_ads, lines, pgi, prefix, schema, text, vnr_1, vnr_2;
        ({ads} = cfg);
        ({schema, prefix} = this.cfg);
        //.......................................................................................................
...
create view ${schema}.brps as select
  ...
  where br is not null;`);
        ...
        while (true) {
          ...
          text = this.db.single_value(SQL`select
    group_concat( chrs, '' ) as chrs
  from ${schema}.ads
  where true
    and pgi = $pgi
    and adi between $adi_1 and $adi_2
  order by vnr_blob;`, {adi_1, adi_2, pgi});
