  ...
  this.Drb_distribution = (clasz = Object) => {
    return class extends clasz {
      ...
      _distribute_with_db(cfg) {
        var ads, insert_into_ads, mm_p_u, prefix, schema, width_mm;
...
;`);
        ...
        debug('^3321^', console.table(this.db.all_rows(SQL`select * from ${schema}.ads;`)));
        debug('^3321^', console.table(this.db.all_rows(SQL`select * from ${schema}.brps order by adi;`)));
