  ...
  this.Drb_distribution = (clasz = Object) => {
    return class extends clasz {
      ...
      _distribute_with_db(cfg) {
        ...
        //.......................................................................................................
        console.table(this.db.all_rows(SQL`select doc, par, adi, vrt, vnr, gid, b, x, y, dx, dy, x1, chrs, sid, nobr, br from ${schema}.ads order by vnr_blob;`));
        console.table(this.db.all_rows(SQL`select doc, par, adi, vrt, vnr, gid, b, x, y, dx, dy, x1, chrs, sid, br, deviation from ${schema}.brps order by vnr_blob;`));
        console.table(this.db.all_rows(SQL`select doc, par, adi, vrt, vnr, gid, b, x, y, dx, dy, x1, chrs, sid, br, deviation from ${schema}.brps order by abs( deviation ) limit 5;`));
        // console.table @db.all_rows SQL"select * from #{schema}.brps order by vnr_blob;"
        //.......................................................................................................
        this._v.dx0 = 0;
        brp_2 = this.db.single_row(SQL`select doc, par, adi, vrt, vnr, gid, b, x, y, dx, dy, x1, chrs, sid, br, deviation from ${schema}.brps order by vnr_blob limit 1;`);
        console.table([brp_2]);
        ...
        while (true) {
          ...
          brp_1 = brp_2;
          brp_2 = this.db.single_row(SQL`select doc, par, adi, vrt, vnr, gid, b, x, y, dx, dy, x1, chrs, sid, br, deviation from ${schema}.brps order by abs( deviation ) limit 1;`);
          brp_2.vnr = jp(brp_2.vnr);
