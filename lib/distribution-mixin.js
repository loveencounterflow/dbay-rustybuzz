  ...
  this.Drb_distribution = (clasz = Object) => {
    return class extends clasz {
      ...
      _distribute_with_db(cfg) {
        ...
        //.......................................................................................................
        console.table(this.db.all_rows(SQL`select doc, par, adi, vrt, vnr, gid, b, x, y, dx, dy, x1, chrs, sid, sgi, nobr, br from ${schema}.ads order by vnr_blob;`));
        console.table(this.db.all_rows(SQL`select doc, par, adi, vrt, vnr, gid, b, x, y, dx, dy, x1, chrs, sid, sgi, nobr, br, deviation from ${schema}.brps where br = 'shy' order by vnr_blob;`));
        console.table(this.db.all_rows(SQL`select doc, par, adi, vrt, vnr, gid, b, x, y, dx, dy, x1, chrs, sid, sgi, nobr, br, deviation from ${schema}.brps order by abs( deviation ) limit 5;`));
        ...
        while (true) {
          ...
          brp_1 = brp_2;
          brp_2 = this.db.single_row(SQL`select doc, par, adi, vrt, vnr, gid, b, x, y, dx, dy, x1, chrs, sid, sgi, nobr, br, deviation from ${schema}.brps order by abs( deviation ) limit 1;`);
          brp_2.vnr = jp(brp_2.vnr);
