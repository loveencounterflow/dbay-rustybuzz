  ...
  this.Drb_outlines = (clasz = Object) => {
    return class extends clasz {
      ...
      _shape_hyphenated(cfg) {
        var R, ad, ads, doc, fontnick, i, len, par, shy_adi, shy_adi_1, shy_adi_2, shy_segments, texts, vrt;
        ({fontnick, ads, shy_segments, doc, par, vrt} = cfg);
        R = [];
        //.......................................................................................................
        texts = [];
        for (i = 0, len = shy_segments.length; i < len; i++) {
          ...
          urge('^5006^', (function() {
            ...
            ref = ads.slice(shy_adi_1, +shy_adi + 1 || 9e9);
            results = [];
      ...
      _prepare_ads(text, fontnick, ads) {
        ...
        var R, ad, adi, bytes, i, len, nxt_b, prv_ad, ref, ref1, special_chrs;
        R = [];
        ({special_chrs} = this.constructor.C);
