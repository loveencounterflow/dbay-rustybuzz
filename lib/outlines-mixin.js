(function() {
  ...
  this.Drb_outlines = (clasz = Object) => {
    return class extends clasz {
      ...
      //---------------------------------------------------------------------------------------------------------
      get_cgid_map(cfg) {
        var R, chrs, font_idx, fontnick, i, len, sd, sds, text, xads;
        ...
        ({xads, chrs, fontnick} = cfg);
        if (xads != null) {
          return this._get_cgid_map_from_xads(xads);
        }
        font_idx = this._font_idx_from_fontnick(fontnick);
        if (this.types.isa.list(chrs)) {
          text = chrs.join('\n');
      ...
      //---------------------------------------------------------------------------------------------------------
      _get_cgid_map_from_xads(xads) {
        var R, ad, i, j, len, len1, xad;
        R = new Map();
        for (i = 0, len = xads.length; i < len; i++) {
          xad = xads[i];
          for (j = 0, len1 = xad.length; j < len1; j++) {
            ad = xad[j];
      ...
      shape_text(cfg) {
        var ad, adi, ads, bytes, ced_x, ced_y, ed_x, font_idx, fontnick, i, j, len, len1, missing, nxt_b, ref, ref1, special_chrs, text, width, xad, xadi, xads;
        ...
        for (xadi = i = 0, len = xads.length; i < len; xadi = ++i) {
          xad = xads[xadi];
          for (adi = j = 0, len1 = xad.length; j < len1; adi = ++j) {
            ad = xad[adi];
      ...
      * insert_and_walk_outlines(cfg) {
        var bbox, cgid_map, chrs, error, fontnick, gid, insert_outline, missing, pd, pd_blob, row, x, x1, xads, y, y1, z;
        ...
        ({fontnick, chrs, cgid_map, xads} = cfg);
        if (cgid_map == null) {
          cgid_map = this.get_cgid_map({fontnick, chrs, xads});
        }
      ...
      //-----------------------------------------------------------------------------------------------------------
      compose(cfg) {
        var ad, fm, fontnick, i, j, k, known_ods, l, len, len1, len2, len3, missing, missing_ads, missing_chrs, new_ods, od, ref, ref1, required_sids, text, xad, xads;
        ...
        xads = this.shape_text({fontnick, text});
        for (i = 0, len = xads.length; i < len; i++) {
          xad = xads[i];
          for (j = 0, len1 = xad.length; j < len1; j++) {
            ad = xad[j];
            missing_ads[ad.sid] = ad;
          }
        }
        //.......................................................................................................
...
where ( gid != 0 ) and ( sid in ${this.db.sql.V(required_sids)} );`);
        ...
        ref1 = this.insert_and_walk_outlines({fontnick, xads});
        //.......................................................................................................
        ...
        //.......................................................................................................
        missing_chrs = [];
        for (k = 0, len2 = xads.length; k < len2; k++) {
          xad = xads[k];
          for (l = 0, len3 = xad.length; l < len3; l++) {
            ad = xad[l];
            if (ad.gid === missing.gid) {
              missing_chrs.push(ad);
            }
          }
        }
        //.......................................................................................................
        return {known_ods, new_ods, missing_chrs, xads, fm};
      }
