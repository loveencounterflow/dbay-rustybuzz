(function() {
  ...
  this.Drb_outlines = (clasz = Object) => {
    return class extends clasz {
      ...
      shape_text(cfg) {
        var R, ad, adi, ads, bytes, ced_x, ced_y, ed_x, font_idx, fontnick, i, len, missing, nxt_b, ref, ref1, special_chrs, text, width;
        ...
        for (adi = i = 0, len = R.length; i < len; adi = ++i) {
          ad = R[adi];
          nxt_b = (ref = (ref1 = R[adi + 1]) != null ? ref1.b : void 0) != null ? ref : 2e308;
