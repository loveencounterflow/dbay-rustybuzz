  ...
  this.Drb_outlines = (clasz = Object) => {
    return class extends clasz {
      ...
      _shape_hyphenated(cfg) {
        var R, ad, adi, ads, brpis, doc, fontnick, par, texts, vrt;
      ...
      /* 'arrange()' like 'compose()' and 'distribute()' */
      shape_text(cfg) {
        var ad, adi, ads, bytes, ced_x, ced_y, doc, ed_x, font_idx, fontnick, i, last_ad, last_adi, len, missing, nxt_b, par, ref, ref1, ref2, ref3, sgi, special_chrs, text, this_adi, vrt, width;
