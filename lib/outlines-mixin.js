  ...
  this.Drb_outlines = (clasz = Object) => {
    return class extends clasz {
      ...
      _shape_hyphenated(cfg) {
        var R, ad, adi, ads, doc, fontnick, i, len, par, ref, texts, vrt;
        ({fontnick, ads, doc, par, vrt} = cfg);
        R = [];
        //.......................................................................................................
        texts = [];
        ref = (function() {
          var j, len, results;
          results = [];
          for (adi = j = 0, len = ads.length; j < len; adi = ++j) {
            ad = ads[adi];
            if (ad.br === 'shy') {
              results.push(adi);
            }
      ...
      /* 'arrange()' like 'compose()' and 'distribute()' */
      _shape_text(cfg) {
        var ad, adi, ads, bytes, ced_x, ced_y, doc, ed_x, font_idx, fontnick, i, last_ad, last_adi, len, missing, nxt_b, par, ref, ref1, ref2, ref3, sgi, shys, special_chrs, text, this_adi, vrt, width;
