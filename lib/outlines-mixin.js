...
where ( gid != 0 ) and ( sid in ${this.db.sql.V(required_sids)} );`);
      ...
      //   return R
        ...
        //-----------------------------------------------------------------------------------------------------------
      distribute(cfg) {
        var R, ad, adi, ads, brp, brpi, brps, corrected_x, delta_width, i, last_adi, last_brpi, left_adi, left_brpi, len, line, lines, mm_p_u, right_adi, right_brpi, width_mm, width_u;
        ...
        while (true) {
          ...
          left_adi = (right_adi != null ? right_adi : brps[left_brpi].adi - 1) + 1;
