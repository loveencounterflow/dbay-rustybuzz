...
where ( gid != 0 ) and ( sid in ${this.db.sql.V(required_sids)} );`);
      ...
      //   return R
        ...
        //-----------------------------------------------------------------------------------------------------------
      distribute(cfg) {
        var R, ad, adi, adi1, adi2, ads, brp, brpi, brpi1, brpi2, brps, corrected_x, dx0, i, j, last_adi, last_brpi, len, len1, line, lines, mm_p_u, width_mm, width_u;
