(function() {
  ...
  this.Drb_outlines = (clasz = Object) => {
    return class extends clasz {
      ...
      //-----------------------------------------------------------------------------------------------------------
      shape_text(cfg) {
        var R, ads, bytes, ced_x, ced_y, d, ed_x, font_idx, fontnick, i, idx, len, missing, nxt_b, ref, ref1, text, width;
      ...
      * insert_and_walk_outlines(cfg) {
        var ads, bbox, cgid_map, chrs, error, fontnick, gid, insert_outline, pd, pd_blob, x, x1, y, y1, z;
      ...
      //-----------------------------------------------------------------------------------------------------------
      typeset(cfg) {
        var ads, d, fm, fontnick, i, known_ods, len, missing_ad, missing_ads, missing_chrs, new_ods, od, ref, ref1, required_sids, sid, text;
        ...
        ref = this.db(SQL`select * from outlines
...
//.......................................................................................................
        for (sid in missing_ads) {
          missing_ad = missing_ads[sid];
          missing_chrs.push({
            chrs: missing_ad.chrs,
            x: missing_ad.x,
            y: missing_ad.y
          });
        }
