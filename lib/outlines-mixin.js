  ...
  this.Drb_outlines = (clasz = Object) => {
    return class extends clasz {
      ...
      _shape_hyphenated(cfg) {
        var R, ad, adi, ads, doc, fontnick, i, j, len, len1, par, ref, shy, shy_segments, texts, vrt;
        ...
        ref = (function() {
          var k, len1, results;
          results = [];
          for (adi = k = 0, len1 = ads.length; k < len1; adi = ++k) {
            ad = ads[adi];
            if (ad.br === 'shy') {
              results.push(adi);
            }
      ...
      /* 'arrange()' like 'compose()' and 'distribute()' */
      _shape_text(cfg) {
        var ad, adi, ads, bytes, ced_x, ced_y, doc, ed_x, font_idx, fontnick, i, last_ad, last_adi, len, missing, nxt_b, par, ref, ref1, ref2, ref3, sgi, shy_segments, special_chrs, text, this_adi, vrt, width;
        ...
        for (adi = i = 0, len = ads.length; i < len; adi = ++i) {
          ...
          if ((!ad.nobr) && (((ref = ads[adi + 1]) != null ? ref.nobr : void 0) || ((ref1 = ads[adi - 1]) != null ? ref1.nobr : void 0))) {
            sgi++;
          }
          ad.sgi = sgi;
          ad.doc = doc;
          ...
          nxt_b = (ref2 = (ref3 = ads[adi + 1]) != null ? ref3.b : void 0) != null ? ref2 : 2e308;
