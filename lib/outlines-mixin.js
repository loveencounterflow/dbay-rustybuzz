(function() {
  ...
  this.Drb_outlines = (clasz = Object) => {
    return class extends clasz {
      ...
      //-----------------------------------------------------------------------------------------------------------
      _compress_svg_pathdata(svg_pathdata) {
        return ZLIB.deflateRawSync(Buffer.from(svg_pathdata), {
          level: 1,
      ...
      //-----------------------------------------------------------------------------------------------------------
      _decompress_svg_pathdata(pd_blob) {
        return ZLIB.inflateRawSync(pd_blob);
      }

      //-----------------------------------------------------------------------------------------------------------
      prepare_insert_outline() {
