(function() {
  ...
  this.Drb_outlines = (clasz = Object) => {
    ...
    return _class = class extends clasz {
      ...
      //---------------------------------------------------------------------------------------------------------
      get_cgid_map(cfg) {
        var R, chr, cid, cids, font_idx, fontnick, gid, gids, i, idx, len, text;
      ...
      insert_outlines(cfg) {
        var cgid_map, cids, fontnick, insert_outline, text;
        ...
        ({fontnick, text, cids, cgid_map} = cfg);
        if (cgid_map == null) {
          cgid_map = this.get_cgid_map({fontnick, text, cids});
        }
